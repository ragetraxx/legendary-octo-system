...
# FFmpeg command with MilkDrop-style visualizer + correctly scaled logo
ffmpeg_cmd = [
    "ffmpeg",
    "-re", "-i", audio_url,
    ...
    "[2:v]scale=250:-1[logo]; "  # Resize logo to 250px width, auto height
    "[bg_visual][logo]overlay=x=(W-w)/2:y=20[out]",  # Centered logo at the top
...
try:
    ...
    print("FFmpeg stream started with dynamic visualizer and correctly sized logo.")
