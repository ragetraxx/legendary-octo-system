...
# === FFmpeg Command ===
# Using hard-coded 720 (Width) and 1280 (Height) to avoid evaluation errors
ffmpeg_cmd = [
    "ffmpeg",
    "-re", "-i", stream_url,
    ...
    "[bg][spec]overlay=0:560:format=auto[bgsp];"
    "[bgsp][vol]overlay=0:1160:format=auto[bgspv];"
    # Hard-coded positions: 720-320=400, 1280-300=980
    "[bgspv]drawbox=x=400:y=200:w=300:h=200:t=fill:c=black@0.6[boxed];"
    f"[boxed]drawtext=fontfile={font_path}:fontcolor=white:fontsize=24:borderw=2:bordercolor=black@0.6:x=420:y=240:"
